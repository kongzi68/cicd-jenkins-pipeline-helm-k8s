...
pipeline {
  ...
  parameters {
    ...
    choice (choices: ['portfolio-risk-research-management'],
            ...
            for (namespaces in params.DEPLOY_TO_ENV.tokenize(',')) {
              ...
              configFileProvider([configFile(fileId: "${K8S_AUTH}", targetLocation: "kube-config.yaml")]){
                ...
                if (getDeployName == deploy_svc_name) {
                  ...
                  helm_values_file="temp_jenkins_workspace/new-${project}/portfolio-risk-research-management/deployToK8s/${deploy_svc_name}-values.yaml"
