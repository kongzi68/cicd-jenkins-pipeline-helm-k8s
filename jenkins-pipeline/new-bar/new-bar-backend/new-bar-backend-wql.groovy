#!groovy
/* 导入Jenkins共享库 */
@Library('bf-shared-library@chengdu-wql') _
...
pipeline {
  ...
  parameters {
    ...
    extendedChoice description: '发版到选中的运行环境',
                   ...
                   saveJSONParameterToFile: false,
                   type: 'PT_CHECKBOX',
                   value: 'new-rab-dev-1,new-rab-dev-2,new-rab-staging-1,new-rab-staging-3,new-rab-dev-4,new-rab-staging-4',
                   visibleItemCount: 10
    booleanParam defaultValue: false,
        ...
        script {
          ...
          for (deploy_svc_name in params.DEPLOY_SVC_NAME.tokenize(',')) {
            ...
            for (namespaces in params.DEPLOY_TO_ENV.tokenize(',')) {
              ...
              switch(namespaces) {
                // api4
                case ['new-rab-dev-4', 'new-rab-staging-4']:
                  // 二进制缓存
