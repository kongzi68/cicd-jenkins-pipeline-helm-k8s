...
pipeline {
  ...
  parameters {
    ...
    extendedChoice description: '发版到选中的运行环境',
                   ...
                   saveJSONParameterToFile: false,
                   type: 'PT_CHECKBOX',
                   value: 'new-rab-dev-1,new-rab-dev-2,new-rab-staging-1,new-rab-staging-3,new-rab-dev-3,new-rab-dev-4,new-rab-dev-5,new-rab-staging-4,product-rack-staging-1',
                   visibleItemCount: 10
    booleanParam defaultValue: false,
