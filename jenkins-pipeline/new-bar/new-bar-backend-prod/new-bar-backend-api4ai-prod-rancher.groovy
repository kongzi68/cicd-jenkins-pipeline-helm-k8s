...
pipeline {
  ...
  parameters {
    ...
    extendedChoice description: '发版到选中的运行环境',
                   ...
                   saveJSONParameterToFile: false,
                   type: 'PT_CHECKBOX',
                   value: 'shanghai-IDC-rab-api4ai-docker-rancher',
                   visibleItemCount: 10
      ...
      steps {
        script {
          ...
          for (deploy_env in params.DEPLOY_TO_ENV.tokenize(',')) {
            switch(deploy_env) {
              case 'shanghai-IDC-rab-api4ai-docker-rancher':
                RANCHER_IP = 'IAmIPaddress'
                // 账号API Keys
                // AccessKey: EBEABD296DF9700DD76C   SecretKey: 9fVZg3RQw3WV3QeDfmXWkYhQJUmm9Mhnnxf9RPbA
                AUTHENTICATION = 'd043dbb2-5d18-4796-b0de-ff621773018e'
                RANCHER_URL = "http://${RANCHER_IP}:8080/v2-beta/projects"
                PROJECT_ID = '1a5'
                STACKS_ID = '1st5'
                RANCHER_SPACES_DIR = 'rab'
                // 环境API Keys
                RANCHER_ACCESS_KEY = '9327948F0D2F755AB30F'
                RANCHER_SECRET_KEY = 'bNDWkvdQuBQwetgFpzygSPVWAuy3rb87AumiSYpR'
              break
              default:
                // error "退出！"
              break
