...
pipeline {
  ...
  parameters {
    ...
    extendedChoice description: '请选择本次发版需要部署的服务',
                   ...
                   type: 'PT_CHECKBOX',
                   value: 'rab-svc-api-app,rab-svc-offline-app,rab-task-data-migration',
                   visibleItemCount: 6
    ...
    extendedChoice description: '发版到选中的运行环境',
                   ...
                   saveJSONParameterToFile: false,
                   type: 'PT_CHECKBOX',
                   value: 'shanghai-IDC-rab-api5-docker-rancher',
                   visibleItemCount: 10
      ...
      steps {
        script {
          ...
          for (deploy_env in params.DEPLOY_TO_ENV.tokenize(',')) {
            switch(deploy_env) {
              case 'shanghai-IDC-rab-api5-docker-rancher':
                RANCHER_IP = 'IAmIPaddress'
                // 账号API Keys
                // AccessKey: 0D6F124DF5016478C1F9   SecretKey: s98hQVMgeJsHyrMUydEv6uqoNL1Fbg75KntynUvK
                AUTHENTICATION = '606bc5da-d26c-4e1d-b56f-30b1c5e4f504'
                RANCHER_URL = "http://${RANCHER_IP}:8080/v2-beta/projects"
                PROJECT_ID = '1a5'
                STACKS_ID = '1st5'
                RANCHER_SPACES_DIR = 'rab-api5'
                // 环境API Keys
                RANCHER_ACCESS_KEY = '4EB28D1AD0C18BC5CDBC'
                RANCHER_SECRET_KEY = 'v1MeKP5aUexChrMg9BaA2CxzoytTncNmTHnJnZU8'
              break
              default:
                // error "退出！"
              break
