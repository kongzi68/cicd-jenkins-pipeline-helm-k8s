...
pipeline {
  ...
  parameters {
    ...
    extendedChoice description: '请选择本次发版需要部署的服务',
                   ...
                   type: 'PT_CHECKBOX',
                   value: 'rab-svc-api-app,rab-svc-offline-app,rab-task-data-migration,rab-webapp,rabbeyond-fe,fund-evaluation-mobile,fund-report',
                   visibleItemCount: 9
    ...
    extendedChoice description: '发版到选中的运行环境',
                   ...
                   saveJSONParameterToFile: false,
                   type: 'PT_CHECKBOX',
                   value: 'shanghai-IDC-rab-api4-docker-rancher',
                   visibleItemCount: 10
      ...
      steps {
        script {
          ...
          for (deploy_env in params.DEPLOY_TO_ENV.tokenize(',')) {
            switch(deploy_env) {
              case 'shanghai-IDC-rab-api4-docker-rancher':
                RANCHER_IP = 'IAmIPaddress'
                // 账号API Keys
                // AccessKey: 7B9B448F33ACA757408B   SecretKey: f8iEmmApWhxAuQGoqSMeom7WB6H8orN1tyKuceEo
                AUTHENTICATION = '2d5be086-10e4-4c4b-a3a3-294f9d2a2f3a'
                RANCHER_URL = "http://${RANCHER_IP}:8080/v2-beta/projects"
                PROJECT_ID = '1a5'
                STACKS_ID = '1st6'
                RANCHER_SPACES_DIR = 'rab'
                // 环境API Keys
                RANCHER_ACCESS_KEY = '699B32D1D12ABA395F68'
                RANCHER_SECRET_KEY = 'G2vLE1tUgFWgAMc4CYgLbTsDN7fYtEhmF11N4Mwj'
              break
              default:
                // error "退出！"
              break
