...
pipeline {
  ...
  parameters {
    ...
    extendedChoice description: '发版到选中的运行环境',
                   ...
                   type: 'PT_CHECKBOX',
                   value: 'new-rab-dev-1,new-rab-dev-2,new-rab-dev-3,new-rab-dev-4,new-rab-staging-1,new-rab-staging-2,new-rab-staging-3,new-rab-staging-4,api4-demo-dev-1,api4-demo-dev-2',
                   visibleItemCount: 10
  }
        ...
        script {
          ...
          for (deploy_svc_name in params.DEPLOY_SVC_NAME.tokenize(',')) {
            ...
            for (namespaces in params.DEPLOY_TO_ENV.tokenize(',')) {
              ...
              println(namespaces)
              helm_values_file="temp_jenkins_workspace/new-rab/counsel-nginx/deployToK8s/${deploy_svc_name}-values.yaml"
              sh """
                pwd
