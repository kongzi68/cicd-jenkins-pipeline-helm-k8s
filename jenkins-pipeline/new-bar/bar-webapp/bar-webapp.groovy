...
pipeline {
  ...
  parameters {
    ...
    extendedChoice description: '发版到选中的运行环境',
                   ...
                   type: 'PT_CHECKBOX',
                   value: 'new-rab-dev-1,new-rab-dev-2,new-rab-dev-3,new-rab-dev-4,new-rab-dev-5,new-rab-staging-1,new-rab-staging-2,new-rab-staging-3,new-rab-staging-4,rab-dev-1,rab-staging-1',
                   visibleItemCount: 15
  }
      ...
      steps {
        script {
          ...
          for (deploy_svc_name in params.DEPLOY_SVC_NAME.tokenize(',')) {
            helm_values_file="temp_jenkins_workspace/new-${project}/rab-webapp/deployToK8s/${deploy_svc_name}-values.yaml"
            // 循环处理需要部署的命名空间
