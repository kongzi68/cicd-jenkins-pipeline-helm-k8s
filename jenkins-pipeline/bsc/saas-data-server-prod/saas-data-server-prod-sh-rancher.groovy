...
pipeline {
  ...
  parameters {
    ...
    extendedChoice description: '请选择本次发版需要部署的服务',
                   ...
                   type: 'PT_CHECKBOX',
                   value: 'data-etl-server,rabbeyond-fe,data-insight-server,inner-grpc-proxy-web',
                   visibleItemCount: 6
    ...
    extendedChoice description: '发版到选中的运行环境',
                   ...
                   saveJSONParameterToFile: false,
                   type: 'PT_CHECKBOX',
                   value: 'shanghai-IDC-saasdata-single-docker-rancher',
                   visibleItemCount: 10
      ...
      steps {
        script {
          ...
          for (deploy_env in params.DEPLOY_TO_ENV.tokenize(',')) {
            switch(deploy_env) {
              case 'shanghai-IDC-saasdata-single-docker-rancher':
                RANCHER_IP = 'IAmIPaddress'
                // 账号API Keys
                // AccessKey: 5804386F975B5B34DBD4   SecretKey: x4ENB79RtgGhDnpCVY2EdXV6ocP15qJR8rnrpQmp
                AUTHENTICATION = '00cbe867-f2fe-4f71-8bfd-3ae95c49bf70'
                RANCHER_URL = "http://${RANCHER_IP}:8080/v2-beta/projects"
                PROJECT_ID = '1a5'
                STACKS_ID = '1st5'
                RANCHER_SPACES_DIR = 'saasdata-single'
                // 环境API Keys
                RANCHER_ACCESS_KEY = '508A5DD2B55C84F122F2'
                RANCHER_SECRET_KEY = '7xM4TDfSH31aaJXNgJ9QuhSF2QwTwJx46pBAWTEm'
              break
              default:
                // error "退出！"
              break
