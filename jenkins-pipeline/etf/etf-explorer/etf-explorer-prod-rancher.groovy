...
pipeline {
  ...
  parameters {
    ...
    extendedChoice description: '请选择本次发版需要部署的服务',
                   ...
                   type: 'PT_CHECKBOX',
                   value: 'etf-explorer-app-svc,etf-explorer-data-sync',
                   visibleItemCount: 6
    extendedChoice description: '发版到选中的运行环境',
                   ...
                   saveJSONParameterToFile: false,
                   type: 'PT_CHECKBOX',
                   value: 'shanghai-IDC-etf-docker-rancher',
                   visibleItemCount: 10
      ...
      steps {
        script {
          ...
          for (deploy_env in params.DEPLOY_TO_ENV.tokenize(',')) {
            switch(deploy_env) {
              case 'shanghai-IDC-etf-docker-rancher':
                RANCHER_IP = 'IAmIPaddress'
                // 账号API Keys
                // AccessKey: E0ACE0D7D630A18B9E42   SecretKey: PS5QoktqUi58iKGWZ2aYxeiBCEbaC2fvZkHAV6VG
                AUTHENTICATION = '75bb441e-48b2-4be9-890a-77597b4d92fc'
                RANCHER_URL = "http://${RANCHER_IP}:8080/v2-beta/projects"
                PROJECT_ID = '1a5'
                STACKS_ID = '1st5'
                RANCHER_SPACES_DIR = 'etf-prod'
                // 环境API Keys
                RANCHER_ACCESS_KEY = '267E8F669ECDFC11A218'
                RANCHER_SECRET_KEY = 'fyFqQABT8VnMTLC86CDZ7yTDNJAZVqSxAF6CJC9W'
              break
              default:
                // error "退出！"
              break
