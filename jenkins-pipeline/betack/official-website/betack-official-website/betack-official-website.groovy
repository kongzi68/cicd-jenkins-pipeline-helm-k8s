...
pipeline {
  ...
  parameters {
    ...
    extendedChoice description: '发版到选中的运行环境',
                   ...
                   type: 'PT_CHECKBOX',
                   value: 'official-website-dev-1,official-website-staging-1,product-rack-dev-1',
                   visibleItemCount: 8
  }
          ...
          for (deploy_svc_name in params.DEPLOY_SVC_NAME.tokenize(',')) {
            ...
            for (namespaces in params.DEPLOY_TO_ENV.tokenize(',')) {
              ...
              sh """
                ...
                cp -a ${helm_values_file} ./${deploy_svc_name}-values.yaml
              ...
              NAMESPACEPREFIX = configEnvPrefix
